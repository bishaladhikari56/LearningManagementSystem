...
import static LMS.ExamStudent.marks;
import static LMS.ExamStudent.totalQuestions;
 ...
 * @author Bishal
 */
public class AssignmentStudent extends javax.swing.JFrame {
     ...
     * Creates new form quizExamStudent*/
     // public String questionId ="1";
      ...
      public String teacherID=IndividualCoursePageStudent.teacherID;
      public String courseID=IndividualCoursePageStudent.courseID;
      public String assignmentName=AutoGeneratedAssignmentButtonStudent.clickedButton;
      public static String totalQuestions;
      
      public void answerCheck()
      {
          //JOptionPane.showMessageDialog(null, totalQuestions);
      ...
      public void question()
      {
          try
        {
            ...
            ResultSet rs1 = st.executeQuery("select * from assignment where teacherID='"+teacherID+"'and questionNum='"+questionNum+"' and courseID='"+courseID+"' and assignmentName= '"+assignmentName+"'");
            while(rs1.next())
            {
      ...
      public void submit()
      {
        ...
        String assignmentName=AutoGeneratedAssignmentButtonStudent.clickedButton;
          answerCheck();
          try
          {
             Connection con = ConnectionProvider.getCon();
    ...
    Timer time;
    public AssignmentStudent(String studentID) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssignmentStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssignmentStudent().setVisible(true);
            }
        });
    }
