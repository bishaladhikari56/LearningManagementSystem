 ...
 * @author Bishal
 */
public class CanvasHomePage extends javax.swing.JFrame {

    /**
     * Creates new form CanvasHomePage
     */
    public CanvasHomePage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblCanvas.setText("Student's Page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanvasHomePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanvasHomePage().setVisible(true);
            }
        });
    }
