...
public class ExamStudent extends javax.swing.JFrame {
     ...
     * Creates new form quizExamStudent*/
      ...
      public String courseID=IndividualCoursePageStudent.courseID;
      ...
      public void answerCheck()
      {
         ...
         /* int questionId1 = Integer.parseInt(questionId);
          ...
          if(questionNum.equals(totalQuestions))
          {
      ...
      public void question()
      {
          try
        {
            teacherID=IndividualCoursePageStudent.teacherID;
            
            String examName=AutoGeneratedExamButtonStudent.clickedButton;
            Connection con = ConnectionProvider.getCon();
            Statement st= con.createStatement();
            
            ResultSet rs1 = st.executeQuery("select * from exam where teacherID='"+teacherID+"' and courseID='"+courseID+"' and examName= '"+examName+"'and questionNum= '"+questionNum+"'");
             //ResultSet rs1 = st.executeQuery("select * from exam" );

            while(rs1.next())
            {
                //txtQuestionNum.setText(rs1.getString(1));
                txtQuestion.setText(rs1.getString(4));
                jRadioButton1.setText(rs1.getString(5));
                jRadioButton2.setText(rs1.getString(6));
                jRadioButton3.setText(rs1.getString(7));
                jRadioButton4.setText(rs1.getString(8));
                answer=rs1.getString(9);
                totalQuestions=rs1.getString(12);
      ...
      public void submit()
      {
          ...
          answerCheck();
          time.stop();
          Double totalQuestions1=Double.valueOf(totalQuestions);
        Double marks1=Double.valueOf(marks);
        Double percentage=((marks1)/(totalQuestions1)*100);
        String assignmentName=AutoGeneratedExamButtonStudent.clickedButton;
        
          try
          {
              
              Connection con = ConnectionProvider.getCon();
              PreparedStatement ps=con.prepareStatement("insert into grades1(studentID,teacherID,courseID,assignmentName,percentage)values(?,?,?,?,?)");
              ps.setString(1,studentID);
              ps.setString(2,teacherID);
              ps.setString(3, courseID);
              ps.setString(4,assignmentName);
              ps.setString(5,String.valueOf(percentage));
              
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null,"Sucessfully Updated the marks to grades table");
              setVisible(false);
              dispose();
              new SucessfullySubmitedExamPage().setVisible(true);
    ...
    Timer time;
    public ExamStudent(String studentID) {
        initComponents();
        ...
        try
        {
            ...
            String teacherID=IndividualCoursePageStudent.teacherID;
            
            String examName=AutoGeneratedExamButtonStudent.clickedButton;
             ResultSet rs1 = st.executeQuery("select * from exam where teacherID='"+teacherID+"'and questionNum='"+questionNum+"' and courseID='"+courseID+"' and examName= '"+examName+"'");
             //ResultSet rs1 = st.executeQuery("select * from exam" );
            while(rs1.next())
            {
                //txtQuestionNum.setText(rs1.getString(1));
