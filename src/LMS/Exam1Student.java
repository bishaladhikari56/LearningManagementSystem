 ...
 * @author Bishal
 */
public class Exam1Student extends javax.swing.JFrame {
     ...
     * Creates new form quizExamStudent*/
      ...
      public void question()
      {
          try
        {
            ...
            ResultSet rs1 = st.executeQuery("select * from exam1 where teacherID=104 and questionNum='"+questionNum+"'");
            while(rs1.next())
            {
      ...
      public void submit()
      {
          ...
          try
          {
              ...
              setVisible(false);
              dispose();
              new SucessfullySubmitedExam1Page(marks1).setVisible(true);
    ...
    Timer time;
    public Exam1Student(String studentID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtSec.setText("00");
        jPanel1.add(txtSec, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 95, -1, 30));
        ...
        jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 17, -1, 50));
        ...
        txtTotal.setText("10");
        jPanel1.add(txtTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, -1, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel16.setText("Your Marks:");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, -1, -1));

        txtMarks.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtMarks.setText("00");
        jPanel1.add(txtMarks, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 130, -1, -1));
        ...
        jPanel1.add(lblStudentID, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 130, -1, -1));
        ...
        jPanel5.add(txtQuestionNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 40, 20));

        txtQuestion.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtQuestion.setText("Question Demo?");
        jPanel5.add(txtQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, -1, -1));
        ...
        jPanel5.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, -1, -1));
        ...
        jPanel5.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, -1, -1));
        ...
        jPanel5.add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, -1, -1));
        ...
        jPanel5.add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 350, -1, -1));
        ...
        jPanel5.add(btnNext, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 460, -1, -1));
        ...
        jPanel5.add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 460, -1, -1));

        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 1360, 580));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exam1Student.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exam1Student().setVisible(true);
            }
        });
    }
